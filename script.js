...
const FEATURED_PROJECTS = [
  ...
  {
    repo: 'ngs',
    label: 'Education · Next-Generation Sequencing',
  ...
  },
  {
    ...
    label: 'Education · Bioinformatics',
  ...
  return `
    <article class="featured-card reveal">
      ...
      <div class="featured-links">
        ...
        ${repo?.homepage ? `<a href="${escapeHtml(repo.homepage)}" target="_blank" rel="noopener noreferrer">Project site ↗</a>` : ''}
      </div>
    </article>`;
}
...
async function fetchGitHubData() {
  try {
    ...
    // Keep the locally supplied professional portrait instead of replacing it with the GitHub avatar.
